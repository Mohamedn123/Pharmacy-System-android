...
public class ViewProductAdmin extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        product1.GetProductByID(ViewProductAdmin.this, ID, new FirebaseFinish() {
            @Override
            ...
            public void GetProductByID(final Product product) {
                ...
                category.GetNameByID(ViewProductAdmin.this, product.getCategory(), new FirebaseFinish() {
                    @Override
                    public void GetAllCategories(ArrayList<com.example.pharmacy.Product.Category> Categories) {
                ...
                Delete.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View v) {
                        product1.DeleteProduct(product.getID() , ViewProductAdmin.this);
                        product1.DeleteImage(product.getImage() , ViewProductAdmin.this);
                    }
                });
